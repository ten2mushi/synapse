// src/flow_matching/path/affine.rs
use burn::{
    module::Module,
...
use crate::flow_matching::scheduler::scheduler::{Scheduler, SchedulerOutput};

/// The scheduler type used by AffineProbPath must also implement Module 
/// AffineProbPath represents a probability path where the transformation between 
/// distributions is affine:
/// X_t = α_t * X_1 + σ_t * X_0
#[derive(Debug)]
...
impl<B: Backend, S: Scheduler<B>> AffineProbPath<B, S> {
    ...
    pub fn velocity_to_epsilon(
        ...
        // denominator: d_sigma_t * alpha_t - d_alpha_t * sigma_t
